...
<?php
$output = shell_exec("python ./src/genius.py $artist 2>&1"); //change this to python3 when uploading to server and also omit 2>&1 when uploading it to AWSBitnami, if not it will generate warnings through python which will make the code unusable
?>
